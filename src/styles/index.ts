...
export const STYLES: readonly StyleDefinition[] = [
  {
    ...
    appearance: { baseLight: '#ece7d8', baseDark: ['#315d43', '#466f49', '#5d7e50', '#738e58'], foundation: ['#d8d0bb', '#c8bea7'], voxelFill: 0.91 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#d8ddbd', baseDark: ['#274b35', '#31583b', '#3b6543', '#203e2e'], foundation: ['#735e45', '#604d39', '#826b4e'], voxelFill: 0.93 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#dbe6df', baseDark: ['#315348', '#3d6252', '#29483f', '#496b58'], foundation: ['#676f6b', '#59625e', '#78807a'], water: ['#9fc4c7', '#afd0d1', '#8db6bc', '#bed8d6'], voxelFill: 0.95 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#e7e6df', baseDark: ['#4c5352', '#5a6260', '#3f4746', '#68706c'], foundation: ['#696861', '#585852', '#7b786e'], voxelFill: 0.96 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#efe3cb', baseDark: ['#7a5140', '#8f6047', '#a46d4c', '#6a473c'], foundation: ['#b58b68', '#9e765c', '#c29b77'], voxelFill: 0.94 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#d9d7cc', baseDark: ['#424a47', '#505854', '#616862', '#343c39'], foundation: ['#777a73', '#666b66', '#898a80'], voxelFill: 0.97 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#ebe6ef', baseDark: ['#40394b', '#51475c', '#62556b'], foundation: ['#81768b', '#70647b', '#94879e'], voxelFill: 0.9 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#eff1ec', baseDark: ['#596164', '#4b5558', '#687174', '#414a4e'], foundation: ['#5b6264', '#4d5659', '#707679'], voxelFill: 0.94 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#b9dce4', baseDark: ['#245663', '#2e6870', '#174a54', '#376f77'], foundation: ['#55787a', '#466769', '#678486'], water: ['#9bcbd8', '#acd7e1', '#b9e0e7', '#8fc3d1'], voxelFill: 0.93 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#eee7d5', baseDark: ['#5a4c3d', '#665846', '#4a4f43', '#735c46'], foundation: ['#8c7f6d', '#756a5b', '#a1937d'], voxelFill: 0.94 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#eee8dc', baseDark: ['#4b433a', '#58493f', '#3d4740', '#645143'], foundation: ['#8d8172', '#756b60', '#a09686'], water: ['#9fbfbd', '#b2cdc7', '#91b3b3', '#c2d7d0'], voxelFill: 0.95 },
  ...
  },
  {
    ...
    appearance: { baseLight: '#cbd9df', baseDark: ['#424e59', '#4d5b67', '#36434f', '#5b6670'], foundation: ['#515b65', '#434c56', '#65707a'], water: ['#66b9c7', '#79c8d2', '#8ed6dc', '#58aebd'], crystal: ['#b9f4f4', '#8fe5ea', '#69ccd8', '#b7e8ff', '#73d9e7'], voxelFill: 0.92 },
