...
export const STYLE_PALETTES = {
  ...
  lighthouse: {
    blossom: { label: 'Harbor', swatch: ['#d6d0bd', '#e6dfcb', '#c4bdab'], colors: ['#d6d0bd', '#b8b09c', '#e6dfcb', '#9d9888', '#c4bdab'], qrDark: '#173f49', baseLight: '#c6e0e4', baseDark: ['#24535d', '#2d626b', '#1e4952'], stone: ['#657a7b', '#758989', '#576b6e'], water: ['#9dcbd5', '#b2d8df', '#8dbfcb', '#c4e2e6'] },
  ...
  temple: {
    blossom: { label: 'Torii', swatch: ['#b54c3e', '#9e3e35', '#89362f'], colors: ['#b54c3e', '#ca6250', '#9e3e35', '#d87a61', '#89362f'], qrDark: '#513029', baseLight: '#f0e9df', baseDark: ['#614139', '#714a40', '#533832'], wood: ['#4b3028', '#603a2d', '#744534'], plaster: ['#e5d8c9', '#d5c5b4', '#efe4d7'], water: ['#a4c2bd', '#b8d0c9', '#91b1ae'] },
